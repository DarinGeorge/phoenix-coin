export const styles = {
  wrapper: 'flex flex-row items-center justify-between px-5 mb-5',
  subTitle: 'text-xs text-gray-400',
  title: 'font-medium text-md',
  input: 'text-md font-medium border border-gray-200 rounded-md p-1 my-1 w-full',
  ...
  buttonDisabled: 'bg-gray-200 text-white',
};
